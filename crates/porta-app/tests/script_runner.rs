...
use porta_testkit::spectral::dominant_freq;
...
fn record_playback_export_roundtrip() {
    ...
    run_script(
        ...
        "session.json",
        r#"{"ops":[
            {"op":"new","dir":"cassette.porta","minutes":1,"seed":7},
            {"op":"arm","track":0},
...
fn undo_erases_the_take() {
    ...
    run_script(
        ...
        "session.json",
        r#"{"ops":[
            {"op":"new","dir":"cassette.porta","minutes":1,"seed":3},
            {"op":"arm","track":2},
            {"op":"record","input_wav":"take.wav"},
            {"op":"undo"},
            {"op":"seek","seconds":0},
...
fn mixer_settings_reach_the_export() {
    ...
    run_script(
        ...
        "session.json",
        r#"{"ops":[
            {"op":"new","dir":"cassette.porta","minutes":1,"seed":1},
            {"op":"arm","track":1},
            {"op":"record","input_wav":"take.wav"},
